...
1. **Read the live task list:**
   - `ZohoCRM_Todo_052126.md` — the canonical Todo. Open tasks + status.
   - `ZohoTaskUpdate_RISE8_052726.md` — the imported 9-task active work plan (historical doc, do not edit; mirror status into the Todo).
...
4. **Cross-reference the architecture-of-record:** `ZohoModuleSpec_ProcurementItems_052626.md` is the source of truth post-05/27 pivot. If a question touches module structure, fields, picklists, or workflow, this is the doc to cite.
...
**Open tasks (top 5 from ZohoCRM_Todo_052126.md):**
- [ ] [task] — [status]
- ...
...
- Do **not** create a `todo.md` — the project tracker is `ZohoCRM_Todo_052126.md`. Stay consistent with the file-naming convention (`DocType_Identifier_MMDDYY`).
